...
=item I<FsQuota::strerr()>

Translates B<errno> to a quota-specific error text. You should always
...
Functions that are supposed return lists, return I<None> upon errors.
